...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "If the thoughts have turned to hurting yourself, that is the point to bring in a person rather than reading anything, including this. Use Quiet Mode for trusted contacts, Ask for police or health options, or go to the nearest clinic, hospital, police post, neighbour, or friend.",
  ...
  },
  {
    ...
    body: [
      ...
      "If your name is on debt you never agreed to, that is a legal problem with a legal answer, and it deserves a proper opinion rather than a family one. Ask can point you to published legal-aid options while GAL works through phone verification.",
